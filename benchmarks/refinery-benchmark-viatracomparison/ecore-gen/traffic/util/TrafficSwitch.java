...
public class TrafficSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TrafficPackage.TRAFFIC_SITUATION: {
				TrafficSituation trafficSituation = (TrafficSituation)theEObject;
				T result = caseTrafficSituation(trafficSituation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TrafficPackage.LANE: {
				Lane lane = (Lane)theEObject;
				T result = caseLane(lane);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TrafficPackage.CAR: {
	 ...
	 * @generated
	 */
	public T caseTrafficSituation(TrafficSituation object) {
		return null;
	}
